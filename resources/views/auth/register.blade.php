  ...
  <body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <!-- @error('error')
          <span class="mt-3 block text-center text-sm font-medium leading-6 text-red-500">{{ $message }}</span>
        @enderror -->
        <ul>
            @foreach ($errors->all() as $error)
            <span class="mt-3 block text-center text-sm font-medium leading-6 text-red-500">{{ $error }}</span>
                <!-- <li>{{ $error }}</li> -->
            @endforeach
        </ul>
